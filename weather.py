...
# 1) Weather temperature in K , C , F  <- three methods
# 2) Wind speed in m/s , km/k , miles/h <- three methods
# 3) Weather conditions : good (wind speed < 5m/s,  temp > 0C < 25 C) ,
# nommal (wind speed < 10m/s,  temp > -15C < 28 C), bad (wind speed > 10m/s,  temp < -15C or > 30 C) ,
